"""
Django settings for creativelink project.
...
SECRET_KEY = 'django-insecure-!(17zv)8ss0yq1(qg)l0g_g&6mh_q$a+=rn8c0gk#u5zbwf^2b'
...
WSGI_APPLICATION = 'creativelink.wsgi.application'
